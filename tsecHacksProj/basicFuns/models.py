...
class Reminders(models.Model):
    ...
    remindTimeStamp = models.DateTimeField(default=datetime.datetime.now())
...
class DailyRemarks(models.Model):
    ...
    remarkFeedback = models.CharField(choices=[(
        'POSTIVE', "POSITIVE"),  ("NEGATIVE", "NEGATIVE"), ("NEUTRAL", "NEUTRAL")], max_length=100)
